...
import com.cengizhanerturan.kotlinnewsapplication.databinding.FragmentMailBinding
    ...
    private fun observeData(view: View) = viewModel.authState.observe(viewLifecycleOwner) { state ->
        when (state) {
            ...
            is AuthState.Success -> {
                viewModel.isLogin = state.authType == AuthType.LOGIN
                ...
                val action = MailFragmentDirections.actionAuthFragmentToPasswordFragment()
